/**
 * Same subset as `src/features/balance/api2.md` “# response” (see also
 * `test/playwright/fixtures/accountAssetsApi2Mock.ts`). Kept under `test/unit`
 * so Vitest/tsc do not cross-import Playwright paths (case-sensitive CI).
 */
...
const API2_MOCK_TOKENS_TEMPLATE = [
  {
    network: 'eth-mainnet',
    tokenAddress: null,
    tokenBalance:
