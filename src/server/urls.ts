export const SERVER_URL = 'https://wapi.testring.org'
export const BALANCE_SERVER_URL = 'https://rw.testring.org'

export const ACCOUNT_ASSETS_URL = `${BALANCE_SERVER_URL}/v1/account_assets`
