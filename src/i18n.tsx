...
const messages = {
  en: {
    ...
    introDevFriendlySub:
      'Built-in dev tools and 1000+ chains. Get Test Token easy',
    ...
    noVisibleTokens: 'No visible assets',
    suspiciousTokens: 'Hidden({count})',
    ...
    receive: 'Receive',
    send: 'Send',
    swapOpenTitle: 'Open Swap',
    swapDisabledNonEvm:
      'Swap is available on Ethereum-compatible networks only',
    walletActionRingSwap: 'Swap',
    walletActionBuy: 'Buy',
    walletActionEarn: 'Earn',
    walletActionPredict: 'Predict',
    walletActionDapp: 'Dapp',
    walletActionBridge: 'Bridge',
    comingSoon: 'Coming soon',
    earnTitle: 'Earn Yield',
    earnDisabledNonEthereum: 'Earn is available on Ethereum mainnet only',
    earnPositions: 'Your Positions',
    earnStrategies: 'Strategies',
    earnStake: 'Stake',
    earnStakeTitle: 'Stake ETH',
    earnTotalYield: 'Total Yield',
    back: 'Back',
    ...
    signAndReview: 'Sign & Review',
    txFieldFrom: 'From',
    txFieldTo: 'To',
    txFieldValue: 'Value',
    txFieldSender: 'Sender',
    txFieldMethod: 'Method',
    txFieldAction: 'Action',
    txFieldGasLimit: 'Gas Limit',
    txFieldCallGasLimit: 'Call Gas Limit',
    txFieldVerificationGas: 'Verification Gas',
    txFieldPreVerificationGas: 'Pre-Verification Gas',
    txFieldAccountStatus: 'Account',
    txFieldDeployed: 'Deployed',
    txFieldNotDeployed: 'Not Deployed',
    txFieldEstimatedFee: 'Estimated Fee',
    txFieldProgram: 'Program',
    txFieldBlockhash: 'Blockhash',
  ...
  zh: {
    ...
    importing: '导入中...',
    noTokensFound: '未找到资产',
    noVisibleTokens: '暂无显示的资产',
    suspiciousTokens: '隐藏({count})',
    clickToExpand: '展开',
    clickToCollapse: '收起',
    tokenColumnName: '名称',
    ...
    walletActionBuy: '购买',
    walletActionEarn: '理财',
    walletActionPredict: '预测',
    walletActionDapp: '应用',
    walletActionBridge: '跨链',
    comingSoon: '即将上线',
    earnTitle: '收益理财',
    earnDisabledNonEthereum: '理财功能仅支持以太坊主网',
    earnPositions: '您的持仓',
    earnStrategies: '策略',
    earnStake: '质押',
    earnStakeTitle: '质押 ETH',
    earnTotalYield: '总收益',
    back: '返回',
    confirming: '确认中...',
    serviceNotAvailable: '暂不可用',
    amount: '金额',
    address: '地址',
    memo: '备注',
    max: '最大',
    ...
    txFieldMethod: '方法',
    txFieldAction: '操作',
    txFieldGasLimit: 'Gas 上限',
    txFieldCallGasLimit: '调用 Gas 上限',
    txFieldVerificationGas: '验证 Gas',
    txFieldPreVerificationGas: '预验证 Gas',
    txFieldAccountStatus: '账户状态',
    txFieldDeployed: '已部署',
    txFieldNotDeployed: '未部署',
    txFieldEstimatedFee: '预估手续费',
    txFieldProgram: '程序',
    txFieldBlockhash: '区块哈希',
    txFieldInputs: '输入数量',
    txFieldChange: '找零',
    txFieldMinerFee: '矿工费',
    txFieldFeeRate: '费率',
