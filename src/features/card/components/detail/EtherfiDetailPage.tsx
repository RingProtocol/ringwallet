...
import CardOverview from '../dashboard/CardOverview'
...
const EtherfiDetailPage: React.FC<Props> = ({
  card,
  onTopUp,
  onSettings,
  onBack,
  ...
  const content = (
    <div className="card-dashboard-page">
      <TitleBar onBack={onBack} backLabel={t('back')}>
        <span className="card-dashboard-page__title">Ether.fi Cash</span>
      </TitleBar>
...
export default EtherfiDetailPage
