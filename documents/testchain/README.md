...
钱包 **E2E** 仍可用 `VITE_ALCHEMY_RPC_KEY`；**Anvil fork** 若遇 403，见 [`test/chain/README.md`](../../test/chain/README.md) Troubleshooting。
...
- **已实现**：仓库内 [`test/chain/README.md`](../../test/chain/README.md) — Vitest 独立配置、`yarn test:chain:*` 分步命令、Sepolia 示例；扩展新链时改 `test/chain/chains/` 与 `cli/run.mjs` 中的模板。
